...
import render.obj.sub.Polygon;
import render.obj.sub.PolygonElement;
...
public class PolygonConvertor implements Convertor<Polygon> {
    ...
    private static PolygonElement createPolygonElement(
        ...
        return new PolygonElement(
                item1.vertices.get(indices1[0]),
                item1.textureCoordinates.get(indices1[1]),
                item1.vertexNormals.get(indices1[2])
        );
    }
